...
import Ansin.web.service.A020201Service;
import Ansin.web.util.EditUtil;
import Ansin.web.vueForm.C010101VueForm;

@Service
public class IA020201ServiceImpl implements A020201Service{
	 ...
	 */
	@Override
	public ApplicantInfoTblBean getApplicantInfo(Integer applicantId) {
		ApplicantConnEntity applicantInfo = applicantInfoTblMapper.getAppl(applicantId);
