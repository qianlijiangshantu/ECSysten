 ...
 */
public class BriefingInfoTblEntity {
	...
	public String toString() {
		return "BriefingInfoTblEntity [briefingId=" + briefingId + ", companyId=" + companyId + ", briefingNm="
				+ briefingNm + ", briefingType=" + briefingType + ", briefingDate=" + briefingDate + ", dateFrom="
				+ dateFrom + ", dateTo=" + dateTo + ", postal=" + postal + ", prefeNm=" + prefeNm
