        ...
        <el-main class="homeBody">
          <div class="bodyRoot">
            <div class="detailTitleInfo">
              <div class="detail_position_nm">{{pdInitData.positionNm}}</div>
            ...
            <div class="positionDetailRoot">
              ...
              <el-row class="detailItemRow detailItemRow1">
               ...
               <el-row class="detailItemRowTitle detailItemRowTitle1">
                <el-col :span="6"><div><em class="el-icon-notebook-1" /> 学歴要求</div></el-col>
              </el-row>
              <el-row class="detailItemRow detailItemRow1">
              ...
              <el-row class="detailItemRowTitle detailItemRowTitle2">
                <el-col :span="6"><div class="detail_welfare_program"><em class="el-icon-present" /> 福利厚生</div></el-col>
              </el-row>
              ...
              <el-row class="detailItemRowTitle detailItemRowTitle3">
                <el-col :span="6"><div><em class="el-icon-suitcase-1" /> 職位説明</div></el-col>
              </el-row>
              ...
              <el-row class="detailItemRowTitle detailItemRowTitle4">
                <el-col :span="6"><div><em class="el-icon-office-building" /> 勤務地</div></el-col>
              </el-row>
                ...
                <el-col :span="24">
                  <div>
                    <el-avatar :size="120" @error="errorHandler" fit :src="this.tableData.logoByte" :key="this.tableData.logoByte">
                      <img :size="120" fit :src="require('@/assets/b_titleico3.png')" />
                    </el-avatar>
                  </div>
                </el-col>
              </el-row>
