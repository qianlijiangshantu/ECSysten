            ...
            <div class="b0102Main">
                ...
                <el-row :gutter="20" type="flex" justify="space-between">
                  ...
                  <el-col :span="4">
                    <el-form-item prop="workingAddress2">
                      <div>
                        <img :src="b0102VueForm.workingAddress2" class="avatar" alt />
                      </div>
                    </el-form-item>
                  </el-col>
                  <el-col :span="11">
                    <el-form-item prop="workingAddress3">
                      <div>
                        <img :src="b0102VueForm.workingAddress3" class="avatar" alt />
                      </div>
                    </el-form-item>
                  </el-col>
                  <el-col :span="10" />
              ...
              <el-row>
                <el-col :span="4" :offset="7">
                  <el-button type="primary" class="b0102Button" @click="sendPositionInfoModify">
                    引き渡す
                  </el-button>
                </el-col>
...
export default {
  ...
  mounted() {
    ...
    this.picurl = "data:image/jpeg;base64," + this.b0102Form.workingAddress1Pic;
  },
  computed: {
    industryComputed() {
      return this.b0102Form.industryCds[this.b0102Form.industryId-1].industryNm;
    },
    jobTypeComputed() {
      return this.b0102Form.jobTypeCds[this.b0102Form.jobTypeId-1].jobtypeNm;
    },
    skillComputed() {
      return this.b0102Form.skillCds[this.b0102Form.skillId-1].skillNm;
    },
  },
  methods: {
    ...
    sendPositionInfoModify() {
      ...
      this.loading = true;
      this.$store
        .dispatch("sendPositionInfoModify", this.b0102VueForm)
        .then((response) => {
          this.loading = false;
