    ...
    >
      <div class="login-container2">
        ...
        <div class="centerLogin">
          ...
          <div class="kaisya_login">管理者ログイン</div>
  ...
  methods: {
    ...
    handleLogin() {
      ...
      this.$refs.loginForm.validate((valid) => {
        if (valid) {
          this.loading = true;
          this.$store
            .dispatch("aLogin", this.loginForm)
            .then((response) => {
              this.loading = false;
              ...
              if (code == 200) {
                ...
                sessionStorage.setItem("userNameA", response.data.data.userName);
    ...
    setCookie(c_name, c_pwd, check, exdays) {
      ...
      window.document.cookie =
        "userNameA" + "=" + cipherCname + ";path=/;expires=" + exdate.toGMTString();
      window.document.cookie =
        "userPwdA" + "=" + cipherCpwd + ";path=/;expires=" + exdate.toGMTString();
      window.document.cookie =
