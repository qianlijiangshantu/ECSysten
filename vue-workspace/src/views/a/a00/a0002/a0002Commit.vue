        ...
        <div class="formcontent">
          ...
          <el-form-item label-width="203px" label="性別:">
            <el-radio
              ...
              label="0"
              v-show="registerForm.sex == '0'"
              >男性</el-radio
            >
            <el-radio
              v-model="registerForm.sex"
              label="1"
              v-show="registerForm.sex == '1'"
              >女性</el-radio
            >
          </el-form-item>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item>
                <el-button class="button-confirm" type="primary" @click="insertKanrisha()"
                  >ログイン画面へ</el-button
                >
              </el-form-item>
            </el-col>
...
export default {
  ...
  methods: {
    insertKanrisha() {
      this.loading = true;
      this.$store
        .dispatch("auserInsert", this.registerForm)
        .then((response) => {
          this.loading = false;
