          ...
          <el-form ref="loginForm">
            <el-row>
              <el-col :span="11" :offset="1">
                <el-form-item label="応募者名前" label-width="6em">
                  <el-input
      ...
      <el-collapse-transition>
        <div class="tableStyle" v-show="tableIsShow">
          <el-table :data="getBriefingApplList">
            ...
            <el-table-column prop="sex" label="性別" width="60">
              <template slot-scope="scope">
               {{sex [scope.row.sex]}} 
              </template>
            </el-table-column>
            <el-table-column prop="prefeNm" label="住所" width="110" />
            <el-table-column prop="station" label="最寄駅" width="100" />
            <el-table-column prop="graduationSchool" label="卒業学校" width="120" />
            <el-table-column prop="graduationMajor" label="専攻" width="200"/>
            <el-table-column prop="userTel" label="電話番号" width="130"/>
