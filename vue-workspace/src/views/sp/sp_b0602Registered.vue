          ...
          >
            ...
            <div class="b0602Main">
              <div class="b0602TableDiv">
                ...
                <el-row :gutter="20" type="flex" justify="space-between" style="width: 280px">
                    <el-col :span="24">
                      <el-form-item
                        prop="teaNm"
                        label="講師氏名："
                      ...
                      <div>
                        ...
                        >
                          <img
                            ...
                            :src="b0602VueForm.photoAddress1"
                            class="avatar"
                            alt=""
                          />
                          <em
                      ...
                      <div v-show="photoAddress > 0">
                        ...
                        >
                          <img
                            ...
                            :src="b0602VueForm.photoAddress2"
                            class="avatar"
                            alt=""
                          />
                          <em
                      ...
                      <div v-show="photoAddress > 1">
                        ...
                        >
                          <img
                            ...
                            :src="b0602VueForm.photoAddress3"
                            class="avatar"
                            alt=""
                          />
                          <em
...
export default {
  ...
  methods: {
    ...
    uploadSuccess(res, file) {
      ...
      this.b0602VueForm.photoAddress1 = URL.createObjectURL(file.raw);
    },
    uploadSuccess2(res, file) {
      this.$message.success("アップロード成功");
      this.b0602VueForm.photoAddress2 = URL.createObjectURL(file.raw);
    },
    uploadSuccess3(res, file) {
      this.$message.success("アップロード成功");
      this.b0602VueForm.photoAddress3 = URL.createObjectURL(file.raw);
    },
    // 画像アップロード失敗
    uploadFail() {
    ...
    clearForm() {
      ...
      this.b0602VueForm.briefingDate = "";
