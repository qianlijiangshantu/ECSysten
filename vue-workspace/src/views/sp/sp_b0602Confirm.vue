                ...
                <el-row :gutter="20" type="flex" justify="space-between">
                  <el-col :span="12">
                    <el-form-item
                      ...
                      :required="true"
                    >
                      {{ b0602Form.date[0] }}-{{ b0602Form.date[1] }}
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row :gutter="20" type="flex" justify="space-between">
              ...
              <el-row>
                <el-col :span="4" :offset="7">
                  <el-button
                    type="primary"
                    class="b0602Button"
                    @click="setB0602VueForm(), sendBriefingInfo()"
                  >
                    引き渡す
                  </el-button>
                </el-col>
...
mounted() {
  ...
  methods: {
    setB0602VueForm() {
      ...
      this.B0602VueForm.dateFrom = this.b0602Form.date[0];
      this.B0602VueForm.dateTo = this.b0602Form.date[1];
