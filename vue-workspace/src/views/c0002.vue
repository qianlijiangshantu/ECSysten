    ...
    <el-card class="register-form-layout">
      ...
      >
        <div class="title">
          ...
          <div class="title-required font-blue-22">応募者新規登録</div>
...
export default {
  data() {
    ...
    let checkFirstNameKana = (rule, value, callback) => {
      let reg = /^[ァ-ヴ!ー]+$/;
      if (!reg.test(value)) {
    ...
    return {
      ...
      rules: {
        ...
        firstNameKana: [
          ...
          { validator: checkFirstNameKana, trigger: "blur" },
        ],
    ...
    handelregister() {
      ...
      this.$refs.registerForm.validate((valid) => {
        ...
        if (valid) {
          ...
          this.loading = true;
          this.$store
            .dispatch("userConf", this.registerForm)
            .then((response) => {
              this.loading = false;
